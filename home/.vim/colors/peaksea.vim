...
"     the original ps_color. Lite version means there's no custom settings and
"     fancy features such as integration with reloaded.vim
"
"     The full version of ps_color.vim will be maintained until Vim 8. By then
"     there will be only the lite version: peaksea.vim
"
" Note: Please set the background option in your .vimrc and/or .gvimrc
"
"     It is much better *not* to set 'background' option inside a colorscheme
"     file.  because ":set background" improperly may cause colorscheme be
"     sourced twice
"
